...
/**
 * @file ptytest.h
 * @brief PTY-based terminal test library for CLI programs.
 *
 ...
 *
 * Depends only on POSIX (openpty/forkpty, fork, poll).
 ...
 *        Sends SIGTERM to the child if still running, SIGKILL after 100ms.
 */
 ...
 * @return Pointer to buf, NUL-terminated, trailing spaces stripped.
 */
